  ...
  module Ecs
    module Component
      class Transform < Fast::ECS::Component
        ...
        def initialize(entity_id : Int32, position_x = 0_f32, position_y = 0_f32, position_z = 0_f32, rotation_x = 0_f32, rotation_y = 0_f32, rotation_z = 0_f32, scale_x = 0_f32, scale_y = 0_f32, scale_z = 0_f32)
          super(entity_id)
