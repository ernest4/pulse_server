  ...
  module Ecs
    module Component
      class PhysicsBody < Fast::ECS::Component
        ...
        def initialize(entity_id : Int32, linear_velocity_x = 0_f32, linear_velocity_y = 0_f32, linear_velocity_z = 0_f32, angular_velocity_x = 0_f32, angular_velocity_y = 0_f32, angular_velocity_z = 0_f32)
          super(entity_id)
